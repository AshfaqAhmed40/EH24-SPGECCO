...
| ------------- | ------------- | ------------- | ------------- |
| Margaret A Murakami | I want to learn specific python libraries for working with these data  | I can help with understanding our dataset, programming in R  | Project Lead |
| Prajvala Kurtakoti | Practice leading a software project | machine learning and python (scipy, scikit-learn) | Project Lead |
| Wenrui Jiang | learning about your dataset | GitHub, Jupyter, cloud computing | Project Helper |
| Ashfaq Ahmed | learn to use github, resolve merge conflicts | I am familiar with our dataset | Team Member  |
| ... | ... | ... | ... |
| ... | ... | ... | ... |
